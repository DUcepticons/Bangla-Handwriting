...
for quality_data in os.listdir(LOCATION): 
    ...
    #model.fit(x_train, y_train, epochs=2 , batch_size=batch_size, shuffle=False, validation_split=0.1)
    ...
    optimizer3=optimizers.Adam(lr=2e-5)
    ...
    model.save(quality_data[0]+'_resnet50_model.h5')
    del model
