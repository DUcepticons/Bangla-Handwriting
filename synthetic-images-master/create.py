...
sizes = [1.2] # different obj sizes to use TODO make configurable
...
if __name__ == "__main__":
    ...
    for bkg in bkg_images:
        ...
        if args.groups:
            ...
            groups = [np.random.randint(0, len(obj_images) -1, np.random.randint(2, 5, 1)) for r in range(len(obj_images))]
    ...
    if args.annotate:
        ...
        # Save annotations
        with open("annotations/"+output_images[-2]+"/annotations.json", "w") as f:
