...
json_files_location="D:/Github Projects/Bangla-Handwriting/Landmark detection/annotated_dataset/All letters/ann"
...
for idx, json_file in enumerate(os.listdir(json_files_location)):
    ...
    keypoints = [([0]*3) for i in range(16)]
    ...
    for sup_keypoint in sup_keypoints:
        ...
        try:
            ...
            number = int(sup_keypoint["classTitle"][2:]) #for a and c which have classTitle like a-0 or c-10
...
with open("all_annotations.json", "w") as write_file:
